...
global.owner = process.env.OWNER_NUMBER  || '94761192103' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LJ8UzZCD#rcYDYGnGhuzs8PWxiitxdxO3nApcdO1AjrQVlHduVkE' ,
